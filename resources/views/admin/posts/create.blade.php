...
<style>
    ...
    .status-indicator { display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem 0.85rem; border-radius: 8px; font-size: 0.85rem; font-weight: 600; background: #f8fafc; border: 1px solid var(--border); margin-bottom: 1rem; }
...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Write and publish a new article or news update.</p>
    </div>
</div>
...
<form action="{{ route('admin.posts.store') }}" method="POST">
    ...
    <div class="form-grid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Enter a clear, descriptive title..." value="{{ old('title') }}" required>
                        @error('title') <div class="error-msg">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Content <span>*</span></label>
                        <textarea name="content" class="form-control" placeholder="Write your post content here..." required>{{ old('content') }}</textarea>
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
            <div class="card">
                <div class="card-header"><span class="card-title">Publishing</span></div>
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-label">Status <span>*</span></label>
                        <select name="status" class="form-control" required id="statusSelect" onchange="updateStatus(this.value)">
                    ...
                    <button type="submit" class="btn-primary">
                        <i data-lucide="send" style="width:16px;height:16px;"></i> Save Post
                    </button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="upload-zone" onclick="document.getElementById('imageUpload').click()">
                        ...
                        <p style="font-size:0.85rem;font-weight:600;">Click to upload</p>
