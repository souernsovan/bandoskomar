    ...
    <div class="container mx-auto px-4 md:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="home-reveal">
                <span class="text-[#F68B1E] font-extrabold uppercase tracking-widest text-sm mb-4 block">{{ $page->content['stats']['heading'] ?? 'Who We Are' }}</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-[#1E2D53] mb-6 leading-tight">{{ $page->content['stats']['title'] ?? 'Bandos Komar Association' }}</h2>
                <p class="text-gray-600 text-lg mb-8 leading-relaxed">{{ $page->content['stats']['description'] ?? 'Building stronger communities through education, health, and emergency relief since 1989.' }}</p>
                <a href="{{ route('frontend.about-us') }}" class="inline-flex items-center gap-3 text-[#1E2D53] font-extrabold text-lg group">
                    Read Our Story
                    <span class="w-10 h-10 rounded-full bg-[#1E2D53]/5 flex items-center justify-center group-hover:bg-[#1E2D53] group-hover:text-white transition-all">
            ...
            <div class="grid grid-cols-2 gap-6">
                @if(isset($page->content['stats']['items']) && is_array($page->content['stats']['items']))
                    @foreach($page->content['stats']['items'] as $item)
                        <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-2xl hover:shadow-[#1E2D53]/5 transition-all text-center group">
                            <span class="block text-4xl font-black text-[#F68B1E] mb-2 group-hover:scale-110 transition-transform">{{ $item['value'] ?? '0' }}</span>
                            <span class="text-gray-500 font-bold uppercase text-xs tracking-widest">{{ $item['label'] ?? '' }}</span>
                        </div>
                    @endforeach
                @else
                    <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 text-center"><span class="block text-4xl font-black text-[#F68B1E] mb-2">5K+</span><span class="text-gray-500 font-bold uppercase text-xs tracking-widest">Students</span></div>
                    <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 text-center"><span class="block text-4xl font-black text-[#F68B1E] mb-2">30+</span><span class="text-gray-500 font-bold uppercase text-xs tracking-widest">Partners</span></div>
                    <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 text-center"><span class="block text-4xl font-black text-[#F68B1E] mb-2">10+</span><span class="text-gray-500 font-bold uppercase text-xs tracking-widest">Years</span></div>
                    <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 text-center"><span class="block text-4xl font-black text-[#F68B1E] mb-2">25</span><span class="text-gray-500 font-bold uppercase text-xs tracking-widest">Provinces</span></div>
                @endif
            </div>
        </div>
    </div>
...
<section class="py-24 bg-gray-50 overflow-hidden">
    <div class="container mx-auto px-4 md:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="home-reveal">
                <span class="text-[#F68B1E] font-extrabold uppercase tracking-widest text-sm mb-4 block">Community First</span>
                <h2 class="text-3xl md:text-5xl font-black text-[#1E2D53] mb-6 leading-tight">Practical support shaped by local families, teachers, and children.</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 class="font-black text-[#1E2D53] mb-2">Schools</h3>
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 class="font-black text-[#1E2D53] mb-2">Families</h3>
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <h3 class="font-black text-[#1E2D53] mb-2">Future</h3>
            ...
            <div class="relative home-reveal">
                ...
                <div class="absolute z-20 -bottom-8 left-8 right-8 bg-white rounded-3xl p-6 shadow-2xl border border-gray-100">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-black text-[#F68B1E] uppercase tracking-widest mb-1">Our promise</p>
                            <p class="text-[#1E2D53] font-extrabold leading-snug">Every action should help children learn, feel safe, and stay connected to opportunity.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-24 bg-gray-50">
    <div class="container mx-auto px-4 md:px-6">
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="text-[#F68B1E] font-extrabold uppercase tracking-widest text-sm mb-4 block">What We Do</span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-[#1E2D53] mb-6 tracking-tight">Our Integrated Programs</h2>
            <div class="w-20 h-1.5 bg-[#F68B1E] mx-auto rounded-full"></div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @if(isset($page->content['programs']) && is_array($page->content['programs']))
                @foreach($page->content['programs'] as $program)
                    <div class="bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 border border-transparent hover:border-[#1E2D53]/5 group relative overflow-hidden">
                        <div class="absolute -right-12 -top-12 w-32 h-32 bg-[#1E2D53] opacity-[0.02] rounded-full group-hover:scale-150 transition-transform duration-700"></div>
                        <div class="w-16 h-16 bg-[#1E2D53]/5 rounded-2xl flex items-center justify-center text-[#1E2D53] mb-8 group-hover:bg-[#1E2D53] group-hover:text-white transition-all duration-300">
                            <i data-lucide="{{ $program['icon'] ?? 'book-open' }}" class="w-8 h-8"></i>
                        </div>
                        <h3 class="text-xl font-extrabold text-[#1E2D53] mb-4">{{ $program['title'] ?? '' }}</h3>
                        <p class="text-gray-500 text-sm leading-relaxed mb-8">{{ $program['description'] ?? '' }}</p>
                        <a href="{{ route('frontend.product') }}" class="inline-flex items-center gap-2 text-[#F68B1E] font-bold text-sm uppercase tracking-wider group/link">
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-4 md:px-6">
        <div class="text-center max-w-3xl mx-auto mb-16 home-reveal">
            <span class="text-[#F68B1E] font-extrabold uppercase tracking-widest text-sm mb-4 block">How We Work</span>
            <h2 class="text-3xl md:text-5xl font-black text-[#1E2D53] mb-6">A simple model for lasting impact</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="home-reveal bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:-translate-y-2 hover:shadow-xl transition-all">
                <div class="w-14 h-14 rounded-2xl bg-[#F68B1E] text-white flex items-center justify-center font-black text-xl mb-8">1</div>
                <h3 class="text-2xl font-black text-[#1E2D53] mb-4">Listen locally</h3>
            ...
            <div class="home-reveal bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:-translate-y-2 hover:shadow-xl transition-all">
                <div class="w-14 h-14 rounded-2xl bg-[#F68B1E] text-white flex items-center justify-center font-black text-xl mb-8">2</div>
                <h3 class="text-2xl font-black text-[#1E2D53] mb-4">Build together</h3>
            ...
            <div class="home-reveal bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:-translate-y-2 hover:shadow-xl transition-all">
                <div class="w-14 h-14 rounded-2xl bg-[#F68B1E] text-white flex items-center justify-center font-black text-xl mb-8">3</div>
                <h3 class="text-2xl font-black text-[#1E2D53] mb-4">Follow through</h3>
...
<section class="py-24 bg-[#1E2D53] relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="home-reveal">
                ...
                <a href="" class="inline-flex items-center gap-3 bg-white text-[#1E2D53] px-8 py-4 rounded-full font-black hover:bg-[#F68B1E] hover:text-white transition-all">
            ...
            <div class="home-reveal grid grid-cols-2 gap-5">
                <div class="bg-white/10 border border-white/10 rounded-3xl p-6 backdrop-blur-sm">
                    <i data-lucide="book-open-check" class="w-9 h-9 text-[#F68B1E] mb-8"></i>
                ...
                <div class="bg-white/10 border border-white/10 rounded-3xl p-6 backdrop-blur-sm mt-10">
                    <i data-lucide="droplets" class="w-9 h-9 text-[#F68B1E] mb-8"></i>
                ...
                <div class="bg-white/10 border border-white/10 rounded-3xl p-6 backdrop-blur-sm">
                    <i data-lucide="users-round" class="w-9 h-9 text-[#F68B1E] mb-8"></i>
                ...
                <div class="bg-white/10 border border-white/10 rounded-3xl p-6 backdrop-blur-sm mt-10">
                    <i data-lucide="shield-check" class="w-9 h-9 text-[#F68B1E] mb-8"></i>
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        <div class="bg-[#1E2D53] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden group">
            ...
            <div class="relative z-10 max-w-3xl mx-auto">
                ...
                <p class="text-gray-300 text-xl mb-12 leading-relaxed">{{ $page->content['cta']['description'] ?? 'Your donation fuels classrooms, teacher training, and emergency relief — turning compassion into action.' }}</p>
                <div class="flex flex-col sm:flex-row justify-center gap-6">
                    <a href="" class="bg-[#F68B1E] text-white px-12 py-5 rounded-full font-black text-xl shadow-2xl hover:scale-105 hover:shadow-[#F68B1E]/50 transition-all">Donate Now</a>
